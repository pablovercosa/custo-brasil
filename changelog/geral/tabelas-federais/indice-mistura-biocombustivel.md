# indice-mistura-biocombustivel

## Correcao de metadados (2026-06-26T16:22:28.249961+00:00)

- Documento: `indice-mistura-biocombustivel`.
- Categoria: `tabela`.
- Fonte: Portal Nacional da Nota Fiscal Eletronica.
- Correcoes aplicadas:
  - metadata:public_paths.document->README.md
  - metadata:status converted->published
  - metadata:category geral->tabela
  - normalized:expanded-from-minimal
- Corrigido em: 2026-06-26T16:22:28.249961+00:00.

---

# Índice de Mistura de Biocombustível

- **Slug:** `indice-mistura-biocombustivel`
- **Categoria:** `geral`
- **Tipo:** `tabelas-federais`
- **Fonte:** `portal_nacional_nfe`

## Histórico

| Data | Versão | Descrição |
|------|--------|-----------|
| 2026-06-26 | 1.0 | Publicação inicial |

## Publicação

- **Data:** 2026-06-26
- **Arquivos:** corpus/geral/tabelas-federais/indice-mistura-biocombustivel/
...
- [Ver no corpus](../../../corpus/geral/tabelas-federais/indice-mistura-biocombustivel/document.md)
- [Metadados do corpus](../../../corpus/geral/tabelas-federais/indice-mistura-biocombustivel/metadata.json)
