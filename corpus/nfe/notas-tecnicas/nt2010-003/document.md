...
original_sha256: "47ffd5500c12892e81e57ec70f13736672404866640734ae021bb5cf053391cf"
converted_at_utc: "2026-06-25T15:15:09.775253+00:00"
status: "published"
type: "nota_tecnica"
---
...
![Image](assets/image_000001_c56c904a37b2268f9861e91e53d996b9bc78dc98cfe3f9f1e22a7ecd463ad417.png)

## Nota Técnica 2010/003

## Divulga alterações do Manual de Integração do Contribuinte - versão 4.01

![Image](assets/image_000002_07007afeea98acdc979848f2d534a1644c3cc255767e08ced4a58681b5f6b8e4.png)
...
| GB22.2   | B22   | Na autorização pela SEFAZ Autorizadora: não aceitar o conteúdo = 2 (SCAN) para tpEmis   | Obrig.   |   570 | Rej.   |
|----------|-------|-----------------------------------------------------------------------------------------|----------|-------|--------|
| GB22.3   | B22   | Na autorização pelo SCAN: não aceitar o conteúdo diferente de 2                         | Obrig.   |   571 | Rej.   |
...
|   570 | Rejeição: tpEmis = 2 só é válido na contingência SC AN                                                                       |
|   571 | Rejeição: O tpEmis informado diferente de 2 para contingência SCAN                                                           |
...
```
<xs:element name="xServ" type="TServ" fixed="STATUS"> <xs:annotation> <xs:documentation>Serviço Solicitado</xs:documentation> </xs:annotation> </xs:element> para: <xs:element name="xServ"> <xs:annotation> <xs:documentation>Serviço Solicitado</xs:documentation> </xs:annotation> <xs:simpleType> <xs:restriction base="TServ"> <xs:enumeration value=" STATUS"/> </xs:restriction> </xs:simpleType> </xs:element>
```
